...
class TradingSystemIntegrationTest {
    ...
    void testServiceInitializationAndHealth() {
        ...
        if (tradingService != null) {
            Assertions.assertTrue(tradingService.isHealthy(), "TradingService应该健康");
            log.info("✅ TradingService 初始化成功");
        }
        ...
        if (quoteService != null) {
            Assertions.assertTrue(quoteService.isHealthy(), "QuoteService应该健康");
            log.info("✅ QuoteService 初始化成功");
        }
        
        if (dataSubscriber != null) {
            Assertions.assertTrue(dataSubscriber.isHealthy(), "RealTimeDataSubscriber应该健康");
            log.info("✅ RealTimeDataSubscriber 初始化成功");
        }
    }
    ...
    void testRealTimeDataSubscription() throws Exception {
        ...
        if (dataSubscriber != null && quoteService != null) {
            ...
            Assertions.assertTrue(subscriptionResult.isSuccess());
