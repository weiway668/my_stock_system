...
public class FutuDataConverter {
    ...
    private static com.trading.domain.entity.CorporateActionEntity buildActionEntity(String stockCode, java.time.LocalDate exDate, com.futu.openapi.pb.QotCommon.RehabOrBuilder futuRehab, com.trading.domain.entity.CorporateActionEntity.CorporateActionType type, double preClose) {
        ...
        switch (type) {
            case DIVIDEND:
                if (futuRehab.hasDividend()) builder.dividend(futuRehab.getDividend());
                if (futuRehab.hasSpDividend()) builder.spDividend(futuRehab.getSpDividend());
                break;
            case SPLIT:
                if (futuRehab.hasSplitBase()) builder.splitBase((double) futuRehab.getSplitBase());
                if (futuRehab.hasSplitErt()) builder.splitErt((double) futuRehab.getSplitErt());
                break;
            case MERGE:
