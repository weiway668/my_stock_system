...
public class TechnicalAnalysisService {
    ...
    private BigDecimal calculateWilliamsR(BarSeries series, String timeframe) {
        ...
        org.ta4j.core.indicators.WilliamsRIndicator williamsR = 
            new org.ta4j.core.indicators.WilliamsRIndicator(series, params.getWilliamsRPeriod());
    ...
    private BigDecimal calculatePlusDI(BarSeries series) {
        ...
        org.ta4j.core.indicators.adx.PlusDIIndicator plusDI = 
            new org.ta4j.core.indicators.adx.PlusDIIndicator(series, 14);
        int lastIndex = series.getEndIndex();
    ...
    private BigDecimal calculateMinusDI(BarSeries series) {
        ...
        org.ta4j.core.indicators.adx.MinusDIIndicator minusDI = 
            new org.ta4j.core.indicators.adx.MinusDIIndicator(series, 14);
        int lastIndex = series.getEndIndex();
    ...
    private BigDecimal calculateVWAP(BarSeries series) {
        ...
        org.ta4j.core.indicators.volume.VWAPIndicator vwap = 
            new org.ta4j.core.indicators.volume.VWAPIndicator(series, 14);
        int lastIndex = series.getEndIndex();
    ...
    public TechnicalIndicators calculateIndicatorsFromData(String symbol, List<MarketData> historicalData) {
        try {
            ...
            log.debug("开始计算技术指标: symbol={}, 使用{}条历史K线", symbol, dataSize);
            ...
            log.debug("从提供的数据计算技术指标成功: symbol={}, dataSize={}, RSI={}, MACD={}", 
                symbol, historicalData.size(), indicators.getRsi(), indicators.getMacdLine());
                
            return indicators;
            
        } catch (Exception e) {
            log.error("从提供的数据计算技术指标失败: symbol={}", symbol, e);
            return createEmptyIndicators();
        }
    }
}